...
module.exports = Command.extend({
  ...
  run: function(commandOptions) {
    getPort({ host: commandOptions.host }).then(function (port) {
      console.log(commandOptions.host, port);
    });
    getPort({ host: 'localhost' }).then(function (port) {
